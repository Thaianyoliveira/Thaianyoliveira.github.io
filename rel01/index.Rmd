...
### Instalações
 ...
 Nesta janela é possível pesquisar os pacotes para serem instalados. Os principais indicados são: knitr e tinytex.
...
```
 ...
 ---
  ...
  Para mais detalhes, acesse [Programação em R (Nível Básico)](https://bendeivide.github.io/cursor/nbasico.html).